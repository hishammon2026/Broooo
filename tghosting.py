...
# --- Configuration ---
TOKEN = "8896654405:AAF3et1_voWuKaGwQNaKTAboQWy2nO6pDlQ" #bot token dalo yeha
OWNER_ID = 8908717915 #yha tumhra chat id dalo
ADMIN_ID = 8908717915 #yeha koi admin ya tumhara chat id dalo
YOUR_USERNAME = '@BAD_DEVIL_999' #yeha tumhra username dala
UPDATE_CHANNEL = '@THE_MALLU_BOTS' #yeha chnl link dalo''
FORCE_JOIN_CHANNELS = {
"@THE_MALLU_BOTSQ":"𝐉𝐎𝐈𝐍",
    ...
    for ch, name in FORCE_JOIN_CHANNELS.items():
        markup.add(
            types.InlineKeyboardButton(
                text=name,
                url=f"https://t.me/THE_MALLU_BOTS"
            )
        )
